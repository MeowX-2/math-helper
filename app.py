...
def handle_404(e):
    """Return JSON for API route 404s or fallback to main app layout."""
...
def handle_500(e):
    """Return structured JSON for API route 500s or fallback to main app layout."""
...
# Application entry point for production and local development
